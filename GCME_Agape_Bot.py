...
text_messages = {'welcome':u'እንካን ወደ አጋፔ መጡ!\n\nየእግዚአብሔርን ፍቅር በግል ማወቅ! '
                 ...
                 'stept6':u'ኢየሱስ ሞትን የመረጠበትን ሁኔታ ስንመለከት አንድ ሰው ራሱን ሊያድን የሚችልበት አቅም እያለው ግን ሆን ብሎ ራሱን በውሃ ውስጥ በመዝፈቅ ሰጥሞ መሞትን ምርጫው የማድረግ አይነት ነው፡፡\n'
...
def replay_send(message):
    if(message.text == 'help'):
        ...
        bot.send_message(message.chat.id, text_messages['step6'], reply_markup=menu1)
